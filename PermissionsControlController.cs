    ...
    public class PermissionsControlController : ControllerBase
    {
        ...
        */
        ...
        private Schema getShema()
        {
            ...
            try
            {
                if(objSchema.Role == null) return objSchema;
            ...
            {
                throw new Exception(ex.Message + "  && getShema, 3");
            }
        ...
        private void filldictDimensionByVirtualCubeXML(Schema objSchema)
        {
            ...
            {
                //if (itemVCub.visible == false) continue; //У виртуальных кубов нет свойства Visible //Оставляем только видимые кубы
